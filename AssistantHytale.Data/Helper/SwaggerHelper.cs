...
namespace AssistantHytale.Data.Helper
{
    public static class SwaggerHelper
    {
        ...
        {
            string description = "API Documentation of the Assistant for Hytale API";
            ...
            {
                Version = version,
                Title = "Assistant for Hytale API",
                Description = description,
                Contact = new OpenApiContact
                {
                    Name = "AssistantHytale",
                    Email = "hytale@kurtlourens.com",
                    Url = new Uri("https://hytaleassistant.com")
                }
            };
            return info;
        }
